...
disable_selinux(){
    ...
    Port81=`netstat -tlpn | awk -F '[: ]+' '$1=="tcp"{print $5}' | grep -w 8`
...
download_pc(){
    ...
    wget https://raw.githubusercontent.com/hkaa0/proxypool/config/config.yaml
    wget https://raw.githubusercontent.com/hkaa0/proxypool/config/source.yaml
